...
export const Button = ({
  ...
  <div onClick={onClick} className={`relative inline-block my-2 ${full ? `w-full` : ""}  transform hover:shadow-2xl hover:-translate-y-0.5 active:shadow:sm active:translate-y-0`}>
    {preTagText && (
      <div
    ...
    <button
      type={submit ? "submit" : ""}
      className={`${
        primary ? `bg-blue-500 text-white px-6 py-2 border-blue-500` : ""
        ...
        full ? `w-full` : ""
      } ${secondary ? `bg-gray-600 text-white px-6 py-2` : ""}  ${
